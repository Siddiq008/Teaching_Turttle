...
import static com.example.sara.verbtest.list;
...
public class verbdashboard extends AppCompatActivity {
    ...
    public void submit() {
        dialog = new Dialog(verbdashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(verbdashboard.this,scorestore.class);
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(verbdashboard.this,verbintro.class);
                Toast toast=Toast.makeText(verbdashboard.this,"You QUIT the text",Toast.LENGTH_SHORT);
