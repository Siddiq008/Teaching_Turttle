...
import static com.example.sara.voicetest.list;
...
public class voicedashboard extends AppCompatActivity {
    ...
    public void submit() {
        dialog = new Dialog(voicedashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(voicedashboard.this,scorestore.class);
                intent.putExtra("correct", correctCount);
                intent.putExtra("wrong" , wrongCount);
                intent.putExtra("Type","Vocies");
                chronometer.stop();
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(voicedashboard.this,voiceintro.class);
                Toast toast=Toast.makeText(voicedashboard.this,"You QUIT the text",Toast.LENGTH_SHORT);
