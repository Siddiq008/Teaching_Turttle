...
import static com.example.sara.idiomtest.list;
...
public class idomdashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_idomdashboard);
    ...
    public void submit() {
        dialog = new Dialog(idomdashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(idomdashboard.this,scorestore.class);
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(idomdashboard.this,idomsintro.class);
                Toast toast = Toast.makeText(idomdashboard.this, "You QUIT the text", Toast.LENGTH_SHORT);
