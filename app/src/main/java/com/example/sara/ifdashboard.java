...
import static com.example.sara.ifctest.list;
...
public class ifdashboard extends AppCompatActivity {
    ...
    public void submit() {
        dialog = new Dialog(ifdashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ifdashboard.this,scorestore.class);
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ifdashboard.this,ifintro.class);
                Toast toast=Toast.makeText(ifdashboard.this,"You QUIT the text",Toast.LENGTH_SHORT);
