...
import static com.example.sara.modtest.list;
...
public class moddashboard extends AppCompatActivity {
    ...
    public void submit() {
        dialog = new Dialog(moddashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(moddashboard.this,scorestore.class);
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(moddashboard.this,Modintro.class);
                Toast toast=Toast.makeText(moddashboard.this,"You QUIT the text",Toast.LENGTH_SHORT);
