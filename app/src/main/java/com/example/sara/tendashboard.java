...
import static com.example.sara.tentest.list;
...
public class tendashboard extends AppCompatActivity {
    ...
    public void submit() {
        dialog = new Dialog(tendashboard.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tendashboard.this,scorestore.class);
                intent.putExtra("correct", correctCount);
                intent.putExtra("wrong" , wrongCount);
                intent.putExtra("Type","Tense");
                chronometer.stop();
    ...
    public void quit(View view) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tendashboard.this,tenseintro.class);
                Toast toast=Toast.makeText(tendashboard.this,"You QUIT the text",Toast.LENGTH_SHORT);
